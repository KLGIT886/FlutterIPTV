      ...
      builder: (context, settings, _) {
        return ListView(
          ...
          children: [
            ...
            // Playlist Settings
            _buildPlaylistSection(context, settings),

            // EPG Settings
            _buildEpgSection(context, settings),

            // DLNA Settings
            _buildDlnaSection(context, settings),

            // Backup & Restore
            _buildBackupSection(context, settings),
            ...
            // Reset
            _buildResetSection(context, settings),
