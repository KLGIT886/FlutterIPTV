...
part 'search_screen_tv_dialog.dart';
...
class _SearchChannelItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChannelCard(
      ...
      onTap: () {
        playChannelFromList(context, channel, logTag: 'SearchScreen');
      },
    );
  }
}
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  /// 供 part 扩展文件（TV 搜索弹窗）刷新 UI：setState 为 protected，扩展内不可直接调用。
  void refreshSearchUi(void Function() fn) => setState(fn);
